...
public class BubbleCrazeKenoWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(BubbleCrazeKenoWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/BubbleCrazeKenoIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/BubbleCrazeKenoIW/InitOutcome.xml").getDocumentElement();
